...
for y in {2015..2020}; do for m in {01..12}; do for d in {01..31}; do for i in {01..10}; do mkdir -p ./$y/$m; echo $y$m$d$i.txt> ./$y/$m/$y$m$d$i.txt; done; done; done; done

mkdir -p {2010..2017}/{01..12}; for i in {2010..2017}; do for j in {01..12}; do for k in {001..004}; do echo 'File '$k >> $i/$j/file$k.txt; done; done; done;
